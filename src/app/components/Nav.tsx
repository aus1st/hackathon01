...
const Nav = () => {
  return (
    <header className='top-0 z-10 sticky'>
      ...
      <input type="search" name="q" className="py-1 text-sm text-white rounded-md pl-10 focus:outline-none border focus:bg-white focus:text-gray-900" placeholder="What are you looking for..." />
        </div>
            </li>
            <li>
                ...
                {/* item qty */}
                <span className='bg-red-600 h-4 w-4 text-white text-sm rounded-full text-center shrink-0 absolute right-2 -top-0.5'>0</span>
                </div>
