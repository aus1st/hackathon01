    ...
    <section>
      <Wrapper>
        ...
        <div className="flex items-center justify-between ml-5">
          ...
          <h1 className="text-6xl leading-[1] mt-10 font-bold font-sora whitespace-pre-line">{heading}</h1>
          
          <p className="mt-16 font-medium text-gray-500 whitespace-pre-line">{p}</p>
          
          
          <button className="bg-black text-white flex gap-2 mt-10 p-5 text-lg font-semibold">
       ...
       {/* features  */}
          ...
          <div className="relative flex-1">
            <div className="py-72 px-72 right-18 top-20 -z-10 absolute rounded-full bg-[#ffece3]">
             
            </div>
            <div>
                <Image src={hero} className="w-650 h-auto mt-14 " alt="hero image" ></Image>
              </div>
          </div>
        </div>
      </Wrapper>
