      ...
      <Wrapper>
        ...
        <div className="flex items-center justify-between ml-5">
          <div className="flex-1">
            ...
            <h1 className="sm:text-6xl text-5xl leading-[1] mt-10 font-bold font-sora sm:whitespace-pre-line">
              {heading}
            </h1>
          ...
          <div className="relative flex-1 hidden sm:block">
            <div className="py-72 px-72 right-18 top-[50px] -z-10 absolute rounded-full bg-[#ffece3]"></div>
            <div>
              <Image
                src={hero}
                className="w-650 mt-14 "
                alt="hero image"
              ></Image>
            </div>
          </div>
